    ...
    return {
      ...
      teamScores: [
        ...
        },
        {
          player: 'Gerard',
          colour: '#C0392B',
          scores: [109, 186, 157, 136, 289, 228, 193, 155, 169, 242, 239, 166],
          total () {
            return this.scores.reduce(
              (accumulator, currentValue) => accumulator + currentValue
            )
        ...
        },
        {
          player: 'Shauna',
          colour: '#7FB3D5',
          scores: [80, 181, 47, 147, 279, 222, 171, 177, 227, 258, 247, 198],
          total () {
            return this.scores.reduce(
              (accumulator, currentValue) => accumulator + currentValue
            )
        ...
        },
        {
          player: 'Stone',
          colour: '#6E2C00',
          scores: [119, 176, 83, 176, 179, 227, 169, 177, 197, 231, 201, 112],
          total () {
            return this.scores.reduce(
              (accumulator, currentValue) => accumulator + currentValue
            )
